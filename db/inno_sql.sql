...
CREATE TABLE `alive_status` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=153035164 DEFAULT CHARSET=latin1;
...
CREATE TABLE `ne_server` (
  ...
  `external_ip` varchar(32) DEFAULT NULL,
  `availability_zone` varchar(32) DEFAULT NULL,
  `hostname` varchar(32) DEFAULT NULL,
  `meta_health` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- Dump completed on 2019-02-25 13:09:38
